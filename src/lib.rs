...
#[derive(Debug)]
pub struct ViteToolsProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ViteToolsProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ViteTools processing");
    
    let mut processor = ViteToolsProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ViteToolsProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ViteToolsProcessor::new(false);
